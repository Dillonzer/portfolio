...
export default function Discord() {
    ...
    <span>
        <Content
            ...
            img={{src: "https://pkmn-tcg-api-images.sfo2.cdn.digitaloceanspaces.com/!Logos/CardBuddy_Card.png", alt: "Card Buddy", height: 700, width: 900}}
        ...
        <Content
            ...
            img={{src: "https://pkmn-tcg-api-images.sfo2.cdn.digitaloceanspaces.com/!Logos/chip%20detail.png", alt: "NetNaviEXE", height: 700, width: 900}}
        ...
        <Content
            ...
            img={{src: "https://pkmn-tcg-api-images.sfo2.cdn.digitaloceanspaces.com/!Logos/PULM_License.png", alt: "PULC License", height: 700, width: 900}}
        ...
        <Content
            ...
            img={{src: "https://pkmn-tcg-api-images.sfo2.cdn.digitaloceanspaces.com/%21Logos/WL_MPRating.png", alt: "WL", height: 700, width: 900}}
        ...
        <Content
            ...
            img={{src: "https://pkmn-tcg-api-images.sfo2.cdn.digitaloceanspaces.com/!Logos/decklistAutomation.png", alt: "DLA", height: 700, width: 900}}
        />
    </span>
